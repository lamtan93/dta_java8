...
public class Optional_01_Test {
    ...
    <T> T find(List<T> list, Predicate<T> predicate,T op) {
        T result = null;
    ...
    public void test_optional_notfound_throw_exception() throws Throwable {
        ...
        Optional<Person> result = Optional.ofNullable(find(personList,p->p.getAge()==10 && p.getFirstname().equals("last-10")));
